angular.module('qAnMp').controller('getQuestions', function($scope, $http){
    ...
    $scope.getQuestions = function(){
        var question;
        var urlTrial = "https://stop-aidz-unity4.herokuapp.com/candidates/1/questions?callback=JSON_CALLBACK"
        $http.jsonp(urlTrial)
...
$scope.postQuestion = function(){
        ...
        for (i = 0; i < 4; i++) {
            ...
            var url = "https://stop-aidz-unity4.herokuapp.com//users/1/candidates/1/asks?question_id=" + toSubmitQ
              $http.post(url)
                .success(function(response){
...
$scope.sendEmail = function(){
  // console.log($scope.userEmail)  
    var urlEmail = "https://stop-aidz-unity4.herokuapp.com/users?email=" + $scope.userEmail
    $http.post(urlEmail)
    .success(function(response){
        console.log(response, 'success')
    })
